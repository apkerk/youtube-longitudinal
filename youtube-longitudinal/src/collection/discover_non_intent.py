...
Usage:
    python -m src.collection.discover_non_intent [--test] [--limit N]
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(config.LOGS_DIR / f'discover_non_intent_{config.get_date_stamp()}.log')
    ]
)
